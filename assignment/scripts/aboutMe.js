...
console.log('Vinny brought home 2 kittens')
pets +=2;
...
//** */GOOD GOD - finally figured out how to edit the above to make the above request apply ^^^^ (ended up changing condition for if & then added else if for if adventurous is true)
